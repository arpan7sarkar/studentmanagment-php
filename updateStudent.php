...
Birthday: <input name="birth" type="date" /><br><br>
...
if(isset($_POST['submit'])){
	...
	$query2 = "UPDATE students SET id='$id',first_name='$first',last_name='$last', street='$street', city='$city', birthday='$birth' WHERE id='$value'";
	$response2 = @mysqli_query($dbc, $query2);
if($response2){
	echo "Successfully Updated!";
}
else{
	echo "Couldn't update the student";
}
